    ...
    return(
        <div>
            <div className="container-konfirmasi-pembayaran">
                <div className="move">
                    <div className="left"><button onClick={handleBack}>Lihat Konfirmasi Pembayaran</button></div>
                    <div className="right"><button onClick={handleNext}>Lihat Pesanan Dikirim</button></div>
                </div>
                <div>
